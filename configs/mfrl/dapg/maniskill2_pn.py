...
agent_cfg = dict(
    ...
    actor_cfg=dict(
        ...
        nn_cfg=dict(
            ...
            visual_nn_cfg=dict(type="RT1"),
            mlp_cfg=dict(
                type="LinearMLP",
                norm_cfg=None,
                # mlp_spec=["512 + agent_shape", 256, 256, "action_shape"],
                mlp_spec=["768+agent_shape", "action_shape"],
    ...
    critic_cfg=dict(
        ...
        nn_cfg=dict(
            ...
            mlp_cfg=dict(
                ...
                type="LinearMLP", norm_cfg=None, mlp_spec=["768 + agent_shape", 1], inactivated_output=True, zero_init_output=True
            ),
        ),
